...
data = data.rename(columns = {"ID": "sample_id", "BEGIN": "Data_time", "Q401": "Activity"})
data = data.iloc[:int(len(data) / 4)]

d3 = D3Blocks()
d3.movingbubbles(data, datetime="Data_time", sample_id="sample_id", state="Activity", filepath="moving_point.html",
